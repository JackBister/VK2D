...
OBJ_FLAGS = -m64 -isystem include -Ibuild/include -ISource -I$(CORE_DIR) -I$(COMPONENT_DIR) -I$(LUA_DIR) -I$(MATH_DIR) -I$(RENDERING_DIR) -std=c++14 -c -o
